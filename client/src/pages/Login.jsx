                ...
                <form className='grid gap-4 py-4' onSubmit={handleSubmit}>
                    <div className='grid gap-1'>
                        ...
                        <input
                            type='email'
                            id='email'
                            className='bg-blue-50 p-2 border rounded outline-none focus:border-blue-800'
                            name='email'
                            value={data.email}
                    ...
                    <div className='grid gap-1'>
                        ...
                        <div className='bg-blue-50 p-2 border rounded flex items-center focus-within:border-blue-800'>
                            <input
                        ...
                        <Link to={"/forgot-password"} className='block ml-auto hover:text-blue-800'>Forgot password ?</Link>
                    </div>
