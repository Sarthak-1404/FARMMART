  ...
  return (
    <div>
        ...
        <div className='text-sm flex items-center gap-2'>
          ...
          <Link onClick={handleClose} to={"/dashboard/profile"} className='hover:text-blue-800'>
        ...
        <div className='text-sm grid gap-1'>
            ...
            {
              isAdmin(user.role) && (
                <Link onClick={handleClose} to={"/dashboard/upload-news"} className='px-2 hover:bg-orange-200 py-1'>Upload News</Link>
              )
            }

            {
              isAdmin(user.role) && (
                <Link onClick={handleClose} to={"/dashboard/news"} className='px-2 hover:bg-orange-200 py-1'>News Managment</Link>
              )
            }
            ...
            <Link onClick={handleClose} to={"/news"} className='px-2 hover:bg-orange-200 py-1'>News</Link>
