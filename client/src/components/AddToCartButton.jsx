...
const AddToCartButton = ({ data }) => {
    ...
    const handleADDTocart = async (e) => {
        ...
        try {
            setLoading(true)
            console.log('Adding to cart:', data?._id)
            ...
            if (responseData.success) {
                console.log('Add to cart success:', responseData)
    ...
    useEffect(() => {
        if (!data) return;
        console.log('Checking cart item:', data._id, cartItem)
        
        // Filter out invalid items from cartItem
